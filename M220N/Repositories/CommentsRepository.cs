...
namespace M220N.Repositories
{
    public class CommentsRepository
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            Builders<Comment>.Filter.Where(c => c.Name.Equals(user.Name) && c.Email.Equals(user.Email) 
            && c.MovieId.Equals(movieId) && c.Id.Equals(commentId)),
            ...
            User user, CancellationToken cancellationToken = default)
        {
            ...
            _commentsCollection.DeleteOne(
                Builders<Comment>.Filter.Where(
                    c => c.MovieId == movieId && c.Name.Equals(user.Name) && c.Email.Equals(user.Email)
                         && c.Id == commentId));
